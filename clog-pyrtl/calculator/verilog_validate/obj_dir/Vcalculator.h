...
#ifndef VERILATED_VCALCULATOR_H_
...
class alignas(VL_CACHE_LINE_BYTES) Vcalculator VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vcalculator___024root* const rootp;
    ...
    explicit Vcalculator(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vcalculator(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vcalculator();
  private:
    VL_UNCOPYABLE(Vcalculator);  ///< Copying not allowed
